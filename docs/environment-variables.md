...
3. Specify an environment variable key and value in the table. You can additionally select the **Secret** checkbox to permanently hide the variable's value after saving it.
