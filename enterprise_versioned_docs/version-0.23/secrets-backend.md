...
4. In the Astronomer UI, set the following [environment variables](environment-variables) in your Airflow Deployment, making sure to paste the entire JSON key file in place of `<your-key-file>`:
