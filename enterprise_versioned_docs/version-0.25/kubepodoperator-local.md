...
When you are ready to deploy this up into Astronomer, follow the [KubePodOperator doc](kubepodoperator) to find a list of the necessary changes that will need to be made.
