...
This guide provides steps for installing the CLI, initializing an Astronomer project, and deploying to an Airflow instance on your local machine. For more information on specific CLI workflows and features, read the [Astronomer CLI Reference Guide](/docs/enterprise/v0.26/resources/cli-reference).
...
> **Note:** As you develop locally, it may be necessary to reset your Docker containers and metadata DB for testing purposes. To do so, run [`astro dev kill`](/docs/enterprise/v0.26/resources/cli-reference#astro-dev-kill) instead of [`astro dev stop`](/docs/enterprise/v0.26/resources/cli-reference#astro-dev-stop) when rebuilding your image. This will delete all data associated with your local Postgres metadata database, including Airflow Connections, logs, and task history.
...
* [Astronomer CLI Reference Guide](/docs/enterprise/v0.26/resources/cli-reference)
