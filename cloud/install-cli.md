...
If you used the `./astro` executable file to run CLI commands, you must complete the following additional setup before using the Astronomer Cloud CLI with any existing Astronomer projects:
